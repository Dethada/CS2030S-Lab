public class Test1 {
  public static void main(String[] args) {
    ...
    we.expect(
        "Actually.err(new ArithmeticException(\"Err\")).equals(Actually.err(new"
            + " Exception(\"Err\")))",
    ...
    we.expect(
        ...
        false);
    we.expect(
        "Actually.ok(\"Err\").equals(\"Err\")", cs2030s.fp.Actually.ok("Err").equals("Err"), false);
    ...
    we.expect(
        ...
        true);
    we.expect(
        "Actually.ok(null).equals(\"Err\")", cs2030s.fp.Actually.ok(null).equals("Err"), false);
    we.expect("Actually.ok(null).equals(null)", cs2030s.fp.Actually.ok(null).equals(null), false);
  }
}
