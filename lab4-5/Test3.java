public class Test3 {
  public static void main(String[] args) {
    ...
    cs2030s.fp.Immutator<Integer, Integer> inc =
        new cs2030s.fp.Immutator<>() {
          public Integer invoke(Integer p) {
            return p + 1;
          }
        };
    cs2030s.fp.Immutator<Integer, Integer> inv =
        new cs2030s.fp.Immutator<>() {
          public Integer invoke(Integer p) {
            return 1 / p;
          }
        };
    cs2030s.fp.Immutator<Number, Integer> incNum =
        new cs2030s.fp.Immutator<>() {
          public Number invoke(Integer p) {
            return p + 1;
          }
        };
    cs2030s.fp.Immutator<Number, Integer> invNum =
        new cs2030s.fp.Immutator<>() {
          public Number invoke(Integer p) {
            return 1 / p;
          }
