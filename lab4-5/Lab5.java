...
class Lab5 {
  public static String getGrade(
    ...
    Constant<Actually<Map<String, Map<String, Map<String, String>>>>> cdb =
        new Constant<>() {
          @Override
          public Actually<Map<String, Map<String, Map<String, String>>>> init() {
            return Actually.<Map<String, Map<String, Map<String, String>>>>ok(db);
          }
        };
    Immutator<
            Actually<Map<String, Map<String, String>>>,
    ...
    return cdb.init().next(getModule).next(getStudent).next(getAssessment).except(errMsg);
  }
  ...
  public static void test3() {
    Immutator<Integer, Integer> inc =
        new Immutator<>() {
          public Integer invoke(Integer p) {
            return p + 1;
          }
        };
    Immutator<Integer, Integer> inv =
        new Immutator<>() {
          public Integer invoke(Integer p) {
            return 1 / p;
          }
        };
    Immutator<Number, Integer> incNum =
        new Immutator<>() {
          public Number invoke(Integer p) {
            return p + 1;
          }
        };
    Immutator<Number, Integer> invNum =
        new Immutator<>() {
          public Number invoke(Integer p) {
            return 1 / p;
          }
  ...
  public static void test4() {
    Transformer<Integer, Integer> inc =
        new Transformer<>() {
          public Integer invoke(Integer p) {
            return p + 1;
          }
        };
    Transformer<Integer, Integer> sqr =
        new Transformer<>() {
          public Integer invoke(Integer p) {
            return p * p;
          }
  ...
  public static void test5() {
    Immutator<Actually<Integer>, Integer> half =
        new Immutator<>() {
    ...
    Immutator<Actually<Integer>, Integer> inc =
        new Immutator<>() {
          public Actually<Integer> invoke(Integer p) {
            return Actually.<Integer>ok(p + 1);
          }
        };
    Immutator<Actually<Integer>, Integer> make =
        new Immutator<>() {
          public Actually<Integer> invoke(Integer p) {
